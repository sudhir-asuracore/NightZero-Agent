...
AVAILABLE_GEMINI_MODELS: Final = [
    ...
    },
    {
        "id": "gemini-2.5-pro",
        "name": "Gemini 2.5 Pro",
        "badge": "MAX REASONING / GA",
        "description": "Flagship frontier intelligence model for ultra-deep root cause forensics and complex patch synthesis.",
        "latency": "~2.5s",
    },
    {
        ...
        "badge": "ULTRA FAST / GA",
        "description": "Ultra-low latency lightweight model optimized for high-speed triage and classification.",
        "latency": "~0.4s",
    },
    {
        "id": "gemini-3.5-flash",
        "name": "Gemini 3.5 Flash",
        "badge": "AGENT PLATFORM / PREVIEW",
        "description": "Next-era agentic flash model listed on GCP Gemini Enterprise Agent Platform.",
        "latency": "~0.9s",
    },
    {
        ...
        "badge": "AGENT PLATFORM / PREVIEW",
        "description": "Preview agent intelligence model in the GCP Agent Platform registry.",
        "latency": "~2.2s",
    },
    {
        "id": "gemini-3.7-flash",
        "name": "Gemini 3.7 Flash",
        "badge": "HYBRID THINKING / PREVIEW",
